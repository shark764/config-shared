...
angular.module('liveopsConfigPanel.shared.services').factory('Tenant', [
  ...
  function(
    ...
    var Tenant = LiveopsResourceFactory.create({
      ...
      updateFields: [
        ...
        { name: 'outboundIntegrationId', optional: true },
        { name: 'defaultIdentityProvider' },
        { name: 'defaultSlaId', optional: true }
      ],
    ...
    Tenant.prototype.updateSessionTenantProps = function(
      updatedTenantData,
      updatedTenantDataPropToCopy,
      targetPropToUpdate
    ) {
